...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>MAITE - kódoló</title>
    </head>
    <body>
        <!-- js app azonosításhoz -->
        <input id="app_id" style="display:none;" value="kodolo" >
        <header class="header">
...
<a href="../szovegbolkep/" class="nav__link">
                        ...
                        <div class="nav__items">
                            ...
                            <a href="#" class="nav__link active">
                                <i class='bx bx-code-alt nav__icon active'></i>
            ...
            <section>
                ...
                <div class="essze_main">
                    <div class="parameter_cim">
                        <p class="essze_parameterek_text" style="margin-top: 5px; margin-left: 0px; text-align: center; font-size: 25px"><b>Kódoló</b> </p>
                    </div>
                    ...
                    <div class="essze_parameterek">
                        <p class="essze_parameterek_text" style="margin-top: 5px; margin-left: 5px; font-size: 18px;"><b>Paraméterek a programodhoz:</b></p>
                        <div class="essze_parameter_flex">
                            <p class="essze_parameterek_subtext" style="margin-top: 3px; margin-left: 15px;"> Milyen programnyelven legyen írva: </p>
                            <input id="nyelv" placeholder="pl. python, bash, c#..." style="font-family: 'Poppins', sans-serif; color: rgb(39, 39, 39)" class="essze_bevitel szoveghossz" style="color: rgb(39, 39, 39);" value="" >
                        </div>
                        <div class="essze_parameter_flex">
                            <p class="essze_parameterek_subtext" style="margin-top: 5px; margin-left: 15px;"> Részletes leírása a programnak:  </p>
                            <textarea id="parameter" placeholder='ide írhatod, hogy mit csináljon a program ' onkeyup="magassag(this)"  class="egyeb_text szoveghossz_textarea" style="margin-top: 4px; color: rgb(39, 39, 39); font-family: 'Poppins', sans-serif; " value="általános" ></textarea>
                            <script>
                    ...
                    <div class="kesz_essze" >
                        <div class="essze_parameter_flex">
                            <p class="kesz_essze_szoveg" style="margin: 5px;"><b>Generált kód:</b> </p>
        ...
        <script src="kodolo_api_kommunikator.js"></script>
    </body>
</html>
