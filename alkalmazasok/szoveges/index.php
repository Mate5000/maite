...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>MAITE - szöveges feladat</title>
    </head>
    <body>
...
<a href="../szovegbolkep/" class="nav__link">
            ...
            <section>
                ...
                <div class="essze_main">
                    <div class="parameter_cim">
                        <p class="essze_parameterek_text" style="margin-top: 5px; margin-left: 0px; text-align: center; font-size: 25px"><b>Szöveges feladat</b> </p>
                    ...
                    <div class="essze_parameterek">
                        <p class="essze_parameterek_text" style="margin-top: 5px; margin-left: 5px; font-size: 18px;"><b>Szöveges feladat részletei:</b></p>
                        
                        <div class="essze_parameter_flex">
                            <p class="essze_parameterek_subtext" style="margin-top: 0px; margin-left: 15px;"> Mennyire legyen részletes:  <i onclick="alert('Ilyen lehet egy részleteségi beállítás:  \n - röviden, csak a megoldást írd le\n - hosszan, fejtsd ki minden lépését  \nés ezekhez hasonlók ')" class='bx bx-help-circle essze_ikon tudasszintek_help'></i></p>
                            <input id="reszletesseg" placeholder="pl. röviden, csak megoldást" style="font-family: 'Poppins', sans-serif; color: rgb(39, 39, 39)"  class="essze_bevitel szoveghossz" style="margin-top: 4px; color: rgb(39, 39, 39);" value="" >
                        </div>
                        <div class="essze_parameter_flex">
                            <script>
                            ...
                            <p class="essze_parameterek_subtext" style="margin-top: 5px; margin-left: 15px;"> A feladat szövege:  </p>
                            <textarea id="feladat" placeholder='ide másolhatod a feladat szövegét' onkeyup="magassag(this)"  class="egyeb_text szoveghossz_textarea" style="margin-top: 4px; color: rgb(39, 39, 39); font-family: 'Poppins', sans-serif; " value="" ></textarea>
                            <script>
                    ...
                    <div class="kesz_essze" >
                        <div class="essze_parameter_flex">
                            <p class="kesz_essze_szoveg" style="margin: 5px;"><b>Feladat megoldása:</b> </p>
        ...
        <script src="szoveges_api_kommunikator.js"></script>
    </body>
</html>
