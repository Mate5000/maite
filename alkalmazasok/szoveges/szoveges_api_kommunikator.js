...
document.querySelector('button').onclick = () => {
    ...
    if(betoltes2.style.display == "none"){
        ...
        const reszletesseg = document.getElementById('reszletesseg').value;
        const feladat = document.getElementById('feladat').value;

        const xhr = new XMLHttpRequest();
        const url = '../../api/request.php';
        const params = `app=${alkalmazas}&reszletesseg=${reszletesseg}&feladatszoveg=${feladat}`;
