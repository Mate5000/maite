...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>MAITE - esszé</title>
    </head>
    <body>
        <!-- js app azonosításhoz -->
        <input id="app_id" style="display:none;" value="essze" >
        <header class="header">
...
<a href="../../profil/info/index.php" class="nav__dropdown-item">Profil</a>
            ...
            <section>
                ...
                <div class="essze_main">
                    ...
                    <div class="parameter_cim">
                        <p class="essze_parameterek_text" style="margin-top: 5px; margin-left: 0px; text-align: center; font-size: 25px"><b>Esszé készítő</b> </p>
                    ...
                    <div class="essze_parancs">
                        <input id="tema" placeholder="Miről szóljon az esszé?"  style="font-family: 'Poppins', sans-serif; color: rgb(39, 39, 39) " id="kereses" class="essze_bevitel">
                        <i class='bx bx-pencil essze_ikon' ><a href="#" id="button" class="start_essze" style="margin-top: 20px;">Start!</a></i>
                    </div>
                    <br>
                    <div class="essze_parameterek">
                        <p class="essze_parameterek_text" style="margin-top: 5px; margin-left: 5px; font-size: 18px;"><b>Paraméterek az esszédhez:</b></p>
                        <div class="essze_parameter_flex">
                            <p class="essze_parameterek_subtext" style="margin-top: 5px; margin-left: 15px;"> A szöveg hossza (szavak száma): </p>
                            <input id="karakterszam" placeholder="szám" style="font-family: 'Poppins', sans-serif; color: rgb(39, 39, 39)" class="essze_bevitel szoveghossz" style="color: rgb(39, 39, 39);" value="100" >
                        </div>
                        <div class="essze_parameter_flex">
                            <p class="essze_parameterek_subtext" style="margin-top: 5px; margin-left: 15px;"> Tudás szint:  <i onclick="alert('Tudásszintek lehetnek a következők például:  \n - 10. osztály\n - középiskola \n - tudományos \n - általános \nés ezekhez hasonlók ')" class='bx bx-help-circle essze_ikon tudasszintek_help'></i></p>
                            <input id="tudasszint" placeholder="általános / stb..." style="font-family: 'Poppins', sans-serif; color: rgb(39, 39, 39)"  class="essze_bevitel szoveghossz" style="margin-top: 4px; color: rgb(39, 39, 39);" value="általános" >
                        </div>
                        <div class="essze_parameter_flex">
                            <script>
                            ...
                            <p class="essze_parameterek_subtext" style="margin-top: 5px; margin-left: 15px;"> Egyéb beállítás:  <i onclick="e_parameter()" class='bx bx-help-circle essze_ikon tudasszintek_help'></i></p>
                            <textarea id="egyeb" placeholder='pl. "Úgy legyen írva, mintha Shakespeare írta volna" ' onkeyup="magassag(this)"  class="egyeb_text szoveghossz_textarea" style="margin-top: 4px; color: rgb(39, 39, 39); font-family: 'Poppins', sans-serif; " value="általános" ></textarea>
                            <script>
                    ...
                    <div class="kesz_essze" >
                        <div class="essze_parameter_flex">
                            <p class="kesz_essze_szoveg" style="margin: 5px;"><b>Generált esszé:</b> </p>
        ...
        <script src="essze_api_kommunikator.js"></script>
    </body>
</html>
