...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>MAITE - kód hibakereső</title>
    </head>
    <body>
        <!-- js app azonosításhoz -->
        <input id="app_id" style="display:none;" value="bug_kereso" >
        <header class="header">
...
<a href="../../profil/info/index.php" class="nav__dropdown-item">Profil</a>
            ...
            <section>
                ...
                <div class="essze_main">
                    <div class="parameter_cim">
                        <p class="essze_parameterek_text" style="margin-top: 5px; margin-left: 0px; text-align: center; font-size: 25px"><b>Kód hibakereső</b> </p>
                    </div>
                    ...
                    <div class="essze_parameterek">
                        <p class="essze_parameterek_text" style="margin-top: 5px; margin-left: 5px;"></p>
                        <div class="essze_parameter_flex">
                            <p class="essze_parameterek_subtext" style="margin-top: 5px; margin-left: 15px;"> A kódod nyelve: </p>
                            <input id="nyelv" placeholder="pl. python" style="font-family: 'Poppins', sans-serif; color: rgb(39, 39, 39)" class="essze_bevitel szoveghossz" style="color: rgb(39, 39, 39);" value="" >
                        </div>
                        <div class="essze_parameter_flex">
                            <p class="essze_parameterek_subtext" style="margin-top: 5px; margin-left: 15px;"> Kód:  </p>
                            <textarea id="program" placeholder='{kód}' onkeyup="magassag(this)"  class="egyeb_text szoveghossz_textarea" style="margin-top: 4px; margin-bottom: 0px; color: rgb(39, 39, 39); font-family: 'Courier New', Courier, monospace; " value="" ></textarea>
                            <script>
                        ...
                        <p style="font-size: 12px; margin-left: 15px;">A kód hibakereső használatával beleegyezel, hogy a kódod nem tartalmaz semmilyen személyes vagy érzékeny adatot. Továbbá ez a kód tárolva lesz elemzések miatt </p>
                        <div class="rajta">
                    ...
                    <div class="kesz_essze" >
                        <div class="essze_parameter_flex">
                            <p class="kesz_essze_szoveg" style="margin: 5px;"><b>Hibakeresési eredmények:</b> </p>
        ...
        <script src="kod_hibakereso_api_kommunikator.js"></script>
    </body>
</html>
