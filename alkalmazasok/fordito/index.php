...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>MAITE - fordító</title>
    </head>
    <body>

        <!-- js app azonosításhoz -->
        <input id="app_id" style="display:none;" value="fordito" >
...
<a href="../../profil/info/index.php" class="nav__dropdown-item">Profil</a>
            ...
            <section>
                ...
                <div class="essze_main">
                    <div class="parameter_cim">
                        <p class="essze_parameterek_text" style="margin-top: 5px; margin-left: 0px; text-align: center; font-size: 25px"><b>Fordító</b> </p>
                    </div>
                    ...
                    <div class="essze_parameterek" style="padding-bottom: 0px;">
                        <p class="essze_parameterek_text" style="margin-top: 5px; margin-left: 5px; font-size: 18px;"><b>Fordítás paraméterei:</b></p>
                        <div class="essze_parameter_flex">
                            <p class="essze_parameterek_subtext" style="margin-top: 3px; margin-left: 15px;"> Milyen nyelvre legyen lefordítva: </p>
                            <input placeholder="ide írhatod a nyelvet" id="nyelv" style="font-family: 'Poppins', sans-serif; color: rgb(39, 39, 39)" class="essze_bevitel szoveghossz" style="color: rgb(39, 39, 39);" value="" >
                        </div>
                        <div class="essze_parameter_flex">
                            <p class="essze_parameterek_subtext" style="margin-top: 3px; margin-left: 15px;"> Fordítandó szöveg:</p>
                            <textarea id="szoveg" placeholder='ide írhatod / másolhatod a forítandó szöveget' onkeyup="magassag(this)"  class="egyeb_text szoveghossz_textarea" style="margin-top: 4px; color: rgb(39, 39, 39); font-family: 'Poppins', sans-serif; min-height: 100px;"  ></textarea>
                            <script>
                    ...
                    <div class="kesz_essze" >
                        <div class="essze_parameter_flex">
                            <p class="kesz_essze_szoveg" style="margin: 5px;"><b>Lefordított szöveg:</b> </p>
        ...
        <script src="fordito_api_kommunikator.js"></script>
    </body>
</html>
