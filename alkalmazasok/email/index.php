...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>MAITE - e-mail</title>
    </head>
    <body>
        <!-- js app azonosításhoz -->
        <input id="app_id" style="display:none;" value="email" >
        <header class="header">
...
<a href="../../profil/info/index.php" class="nav__dropdown-item">Profil</a>
            ...
            <section>
                ...
                <div class="essze_main">
                    <div class="parameter_cim">
                        <p class="essze_parameterek_text" style="margin-top: 5px; margin-left: 0px; text-align: center; font-size: 25px"><b>E-mail író</b> </p>
                    </div>
                    ...
                    <div class="essze_parameterek">
                        <p class="essze_parameterek_text" style="margin-top: 5px; margin-left: 5px;font-size: 18px;"><b>Részletek az e-mailhez:</b></p>
                        <div class="essze_parameter_flex">
                            <p class="essze_parameterek_subtext" style="margin-top: 5px; margin-left: 15px;"> Kinek legyen írva: </p>
                            <input id="cimzett" placeholder="pl. igazgatónak" style="font-family: 'Poppins', sans-serif; color: rgb(39, 39, 39)" class="essze_bevitel szoveghossz" style="color: rgb(39, 39, 39);" value="" >
                        </div>
                        <div class="essze_parameter_flex">
                            <p class="essze_parameterek_subtext" style="margin-top: 5px; margin-left: 15px;"> Milyen legyen a stílusa:  </p>
                            <input id="stilus" placeholder='pl. hivatalos' style="font-family: 'Poppins', sans-serif; color: rgb(39, 39, 39)"  class="essze_bevitel szoveghossz" style="margin-top: 4px; color: rgb(39, 39, 39);" value="" >
                        </div>
                        <div class="essze_parameter_flex">
                            <script>
                            ...
                            <p class="essze_parameterek_subtext" style="margin-top: 5px; margin-left: 15px;"> Tartalom, egyéb beállítás:  </p>
                            <textarea id="egyeb" placeholder='pl. "reklamáció egy termékről, mert nem működik, stb..."' onkeyup="magassag(this)"  class="egyeb_text szoveghossz_textarea" style="margin-top: 4px; color: rgb(39, 39, 39); font-family: 'Poppins', sans-serif; " value="általános" ></textarea>
                            <script>
                    ...
                    <div class="kesz_essze" >
                        <div class="essze_parameter_flex">
                            <p class="kesz_essze_szoveg" style="margin: 5px;"><b>Generált e-mail:</b> </p>
        ...
        <script src="email_api_kommunikator.js"></script>
    </body>
</html>
