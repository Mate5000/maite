    ...
    <body>
        ...
        <header class="header">
            ...
            <p class="keszitette" style=""> MAITE Coinok: <b><?php echo $kszam ?></b></p>
                <a href="index.html" class="header__logo">MAITE</a>
                            ...
                            <div class="nav__dropdown">
                                ...
                                <div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        <a href="profil/nev/" class="nav__dropdown-item">Név</a>
                                        <a href="profil/jelszo/" class="nav__dropdown-item">Jelszó</a>
                                        <a href="profil/elozmenyek/" class="nav__dropdown-item">Előzmények</a>
                                    </div>
                                </div>
                            </div>
                    </div>
        ...
        <main>
            <section>
                <p class="nem_talalhato">Úgy néz ki, hogy hibásan lett elküldve a paraméter a keresőmotornak.</p>
